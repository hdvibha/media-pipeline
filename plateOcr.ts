 ...
 */
export async function checkPlateOcr(filePath: string): Promise<CheckResult & { extractedText: string; plateNumber: string | null; plateValid: boolean }> {
  ...
  try {
    ...
    const regions = imageWidth && imageHeight ? CANDIDATE_REGIONS : [];
